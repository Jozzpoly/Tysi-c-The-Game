...
requireMatch('stable workflow', stable, /Require main validation authority/u);
requireMatch('stable workflow', stable, /refs\/heads\/main/u);
...
requireMatch('stable workflow validation harness', stable, /Checkout current validation harness/u);
requireMatch('stable workflow validation harness', stable, /ref:\s*\$\{\{ github\.sha \}\}/u);
requireMatch('stable workflow validation harness', stable, /path:\s*\.validation-harness/u);
requireMatch('stable workflow validation harness', stable, /working-directory:\s*\.validation-harness/u);
requireMatch('stable workflow validation harness', stable, /Validation harness SHA/u);
requireMatch('stable workflow validation harness', stable, /Product candidate SHA/u);
requireMatch('stable workflow validation harness', stable, /\.validation-harness\/artifacts\/browser\/public-\*\.png/u);
...
requireMatch('stable recheck workflow', recheck, /Require main validation authority/u);
requireMatch('stable recheck workflow', recheck, /refs\/heads\/main/u);
requireMatch('stable recheck workflow', recheck, /Resolve canonical origin and exact product SHA/u);
...
requireMatch('stable recheck workflow', recheck, /git fetch --no-tags --depth=1 origin "\$EXPECTED_SHA"/u);
requireMatch('stable recheck workflow', recheck, /git cat-file -e "\$\{EXPECTED_SHA\}\^\{commit\}"/u);
requireMatch('stable recheck workflow', recheck, /Validation harness SHA/u);
...
forbidMatch('stable recheck workflow', recheck, /ref:\s*\$\{\{ steps\.target\.outputs\.sha \}\}/u);
forbidMatch('stable recheck workflow', recheck, /Checkout the exact candidate harness/u);
