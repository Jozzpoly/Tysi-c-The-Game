...
try {
  ...
  // Automatic remote playback must not outrun perception. Keep a minimum
  // material spacing between authoritative revisions; Owner testing decides
  // whether later optional dwell can be accelerated.
  if (spacingMs < 350) {
